...
int main()
{
    ...
    while ( !done )
    {
        ...
        {
			cout << "Class 1. " << students[modifyIndex].classes[0] << endl;
			cout << "Class 2. " << students[modifyIndex].classes[1] << endl;
			cout << "Class 3. " << students[modifyIndex].classes[2] << endl;
			cout << "Class 4. " << students[modifyIndex].classes[3] << endl;
