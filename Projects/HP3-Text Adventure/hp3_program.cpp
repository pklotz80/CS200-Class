...
void Program::Setup()
{
	...
	Location *ptrCurrentLocation = &locationList[1];
	Location *ptrEndLocation = &locationList[0];
}
...
void Program::Main()
{
	...
	while (!done)
	{
		...
		if (input == "n" && locationList->ptrToNorth != nullptr)
		{
			ptrCurrentLocation = locationList->ptrToNorth;
		}
		else if (input == "s" && locationList->ptrToSouth != nullptr)
		{
			ptrCurrentLocation = locationList->ptrToSouth;
		}
		else if (input == "e" && locationList->ptrToEast != nullptr)
		{
			ptrCurrentLocation = locationList->ptrToEast;
		}
		else if (input == "w" && locationList->ptrToWest != nullptr)
		{
			ptrCurrentLocation = locationList->ptrToWest;
		}
		else if (input == "q")
		{
			done = false;
...
void Program::DisplayCurrentLocation()
{
	...
	if (locationList->ptrToNorth != nullptr)
	{
		cout << "You may travel north." << endl;
	}
	if (locationList->ptrToSouth != nullptr)
	{
		cout << "You may travel south." << endl;
	}
	if (locationList->ptrToEast != nullptr)
	{
		cout << "You may travel east." << endl;
	}
	if (locationList->ptrToWest != nullptr)
	{
